...
## Requirements
--------------
The host that the playbooks are run on will require access to both vCenter and the esxi servers via tcp/443.  **Python** and **ansible** are the base requirements that must be installed.  In addition to python and ansible, the following packages are also required.
