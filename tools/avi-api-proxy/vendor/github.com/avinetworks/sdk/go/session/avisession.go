...
func (avisess *AviSession) RestRequest(verb string, uri string, payload interface{}, tenant string) (*http.Response, error) {
...
func (avisess *AviSession) restRequestInterfaceResponse(verb string, url string,
	...
	resp, rerror := avisess.restRequest(verb, url, payload, opts.tenant, nil)
	if rerror != nil {
		return rerror
	}
...
func (avisess *AviSession) GetCollectionRaw(uri string, options ...ApiOptionsParams) (AviCollectionResult, error) {
	...
	res, rerror := avisess.fetchBody("GET", uri, resp)
	if rerror != nil {
		return result, rerror
	}
...
func (avisess *AviSession) GetRaw(uri string) ([]byte, error) {
	resp, err := avisess.restRequest("GET", uri, nil, "", nil)
	if err != nil {
		return nil, err
	}
...
func (avisess *AviSession) PostRaw(uri string, payload interface{}) ([]byte, error) {
	resp, err := avisess.restRequest("POST", uri, payload, "", nil)
	if err != nil {
		return nil, err
	}
