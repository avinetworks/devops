...
#When the number of results is expected to be large, you can use Get-AviObjectsPaged to return an ArrayList of results aggregated from multiple pages as needed
$VSListPaged = Get-AviObjectsPaged -AviSession $AviSession -Url virtualservice -QueryParams @{refers_to = "applicationprofile:$($SystemHTTP)" }
